...
- Minimal HTTP endpoints: `/api/health`, paginated and filterable `/api/alerts`, `/api/metrics`, rule listing, rule create/update/delete, rule reload, and optional PSK Bearer auth for modifying rule endpoints.
