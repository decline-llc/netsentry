...
- Release-candidate verification bundle via `make rc-check`, including dependency verification, coverage snapshot, fuzz smoke, release archive, Docker image content, and runtime health smoke checks.
