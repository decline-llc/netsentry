...
- Recovery JSONL is read and structurally validated in full before replay.
  ...
  earlier member. Duplicate unknown top-level names are rejected without
  recursively constraining unknown nested values. Valid logs are truncated
