...
aggregation uniqueness contract. It also rejects extra uniqueness constraints,
generated columns, triggers, `CHECK` constraints, and foreign-key relationships that
