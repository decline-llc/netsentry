...
- **Current result:** The empty queue was refreshed on Jul 19 from verified
  ...
  R90-13 is complete. R90-14 was selected next, but its required preflight
  found that the checked-in C reconnect path does not resend hello; its explicit
  stop condition fired, so it is blocked pending a reconnect-handshake product
  decision. No tag or public release is authorized.
